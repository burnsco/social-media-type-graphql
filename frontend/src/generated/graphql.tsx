...
export type IsUserOrEmailTakenQuery = (
  { __typename?: 'Query' }
  & { isUserOrEmailTaken: (
    { __typename?: 'UserMutationResponse' }
    & { errors?: Maybe<Array<(
 ...
 * });
 */
export function useIsUserOrEmailTakenQuery(baseOptions?: Apollo.QueryHookOptions<IsUserOrEmailTakenQuery, IsUserOrEmailTakenQueryVariables>) {
        return Apollo.useQuery<IsUserOrEmailTakenQuery, IsUserOrEmailTakenQueryVariables>(IsUserOrEmailTakenDocument, baseOptions);
      }
export function useIsUserOrEmailTakenLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<IsUserOrEmailTakenQuery, IsUserOrEmailTakenQueryVariables>) {
          return Apollo.useLazyQuery<IsUserOrEmailTakenQuery, IsUserOrEmailTakenQueryVariables>(IsUserOrEmailTakenDocument, baseOptions);
        }
export type IsUserOrEmailTakenQueryHookResult = ReturnType<typeof useIsUserOrEmailTakenQuery>;
export type IsUserOrEmailTakenLazyQueryHookResult = ReturnType<typeof useIsUserOrEmailTakenLazyQuery>;
export type IsUserOrEmailTakenQueryResult = Apollo.QueryResult<IsUserOrEmailTakenQuery, IsUserOrEmailTakenQueryVariables>;
...
export function useUpdateMetaQuery(baseOptions?: Apollo.QueryHookOptions<UpdateMetaQuery, UpdateMetaQueryVariables>) {
        return Apollo.useQuery<UpdateMetaQuery, UpdateMetaQueryVariables>(UpdateMetaDocument, baseOptions);
      }
export function useUpdateMetaLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UpdateMetaQuery, UpdateMetaQueryVariables>) {
          return Apollo.useLazyQuery<UpdateMetaQuery, UpdateMetaQueryVariables>(UpdateMetaDocument, baseOptions);
        }
