...
export type PostDetailsFragment = { __typename?: "Post" } & Pick<
  Post,
  "id" | "createdAt" | "updatedAt" | "title" | "text" | "image" | "link"
>
...
export type SendMessageMutation = { __typename?: "Mutation" } & {
  sendMessage: { __typename?: "UserMutationResponse" } & {
    message?: Maybe<
...
export type MeQuery = { __typename?: "Query" } & {
  me: { __typename?: "User" } & UserMeDetailsFragment
}
...
export type NewCommentsSubscription = { __typename?: "Subscription" } & {
  newComments: { __typename?: "Comment" } & Pick<Comment, "id" | "body"> & {
      createdBy: { __typename?: "User" } & Pick<User, "username">
...
export type NewMessageSubscription = { __typename?: "Subscription" } & {
  newMessage: { __typename?: "Message" } & Pick<Message, "id" | "content"> & {
      sentBy: { __typename?: "User" } & Pick<User, "id" | "username">
      sentTo: { __typename?: "User" } & Pick<User, "id" | "username">
    }
}
...
export function useCommentsForPostQuery(
  ...
  return Apollo.useQuery<CommentsForPostQuery, CommentsForPostQueryVariables>(
    CommentsForPostDocument,
    baseOptions
  )
}
export function useCommentsForPostLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CommentsForPostQuery,
    CommentsForPostQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    CommentsForPostQuery,
    CommentsForPostQueryVariables
  >(CommentsForPostDocument, baseOptions)
}
export type CommentsForPostQueryHookResult = ReturnType<
  typeof useCommentsForPostQuery
>
export type CommentsForPostLazyQueryHookResult = ReturnType<
  typeof useCommentsForPostLazyQuery
>
export type CommentsForPostQueryResult = Apollo.QueryResult<
  CommentsForPostQuery,
  CommentsForPostQueryVariables
>
export function refetchCommentsForPostQuery(
  variables?: CommentsForPostQueryVariables
) {
 ...
 * });
 */
export function useNewCommentsSubscription(
  ...
  return Apollo.useSubscription<
    NewCommentsSubscription,
    NewCommentsSubscriptionVariables
  >(NewCommentsDocument, baseOptions)
}
export type NewCommentsSubscriptionHookResult = ReturnType<
  typeof useNewCommentsSubscription
>
