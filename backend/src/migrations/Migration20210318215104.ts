...
export class Migration20210318215104 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "user" ("id" serial primary key, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "email" varchar(255) not null, "username" varchar(255) not null, "password" varchar(255) not null, "avatar" varchar(255) null, "about" varchar(255) null);');
    ...
    this.addSql('create table "category" ("id" serial primary key, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "name" varchar(20) not null);');
    this.addSql('alter table "category" add constraint "category_name_unique" unique ("name");');

    this.addSql('create table "message" ("id" serial primary key, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "content" varchar(255) not null, "sent_by_id" int4 not null, "category_id" int4 null);');

    this.addSql('create table "post" ("id" serial primary key, "created_at" varchar(255) not null, "updated_at" varchar(255) not null, "title" varchar(255) not null, "text" varchar(255) null, "link" varchar(255) null, "image" varchar(255) null, "image_h" varchar(255) null, "image_w" varchar(255) null, "author_id" int4 not null, "category_id" int4 not null);');
    ...
    this.addSql('create table "base" ("id" serial primary key, "created_at" varchar(255) not null, "updated_at" varchar(255) not null);');
