...
export class Migration20210319171528 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "category" ("id" serial primary key, "created_at" varchar(255) not null, "name" varchar(255) not null);');
