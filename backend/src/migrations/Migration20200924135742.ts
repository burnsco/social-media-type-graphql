...
export class Migration20200924135742 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "post" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "title" varchar(255) not null, "text" varchar(255) null, "link" varchar(255) null, "image" varchar(255) null, "video" varchar(255) null, "author_id" int4 not null, "category_id" int4 not null);');
    ...
    this.addSql('create table "vote" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "value" int4 not null, "cast_by_id" int4 not null, "post_id" int4 not null);');
